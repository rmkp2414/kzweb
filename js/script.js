...
$(document).ready(function(){
	setTimeout( function(){
        ...
        $(".typewrite span").typed({
            strings: ["Nice to eyes responsive designs", "Simple, Timely, Innovative Solutions", "Outsourced Software Development", "Web Application Development" , "Mobile Application Development" ,"IT Consultancy Services"],
            typeSpeed: 200,
            backDelay: 300,
            loop: false,
